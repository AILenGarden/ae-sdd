...
> 源版本：ae-sdd source `8da2bcfdeaad2434` (3.11.5)
>
...
- ae-sdd 主入口：`../source/SKILL.md`（297 行 slim entry，完整语义见 `../source/skill-fallbacks/SKILL.full.md` 849 行）
...
- 生成时间：2026-07-16T03:19:52Z
- 源 ae-sdd 版本：3.11.5
- 源 ae-sdd input hash：8da2bcfdeaad24349581b2bbb4a8adc2832e79a68f0f58a4a3839cd5e9e5c798
- 适配器版本：v0.3.0
