...
> 源版本：ae-sdd source `aab8bfcdf2ee1d02` (3.9.9)
>
...
- ae-sdd 主入口：`../source/SKILL.md`（216 行 slim entry，完整语义见 `../source/skill-fallbacks/SKILL.full.md` 716 行）
...
- 生成时间：2026-07-08T07:24:33Z
- 源 ae-sdd 版本：3.9.9
- 源 ae-sdd input hash：aab8bfcdf2ee1d02ff5a3a207e3e7c7a64a19cb116610ce9a4a0cfa822db965c
- 适配器版本：v0.3.0
