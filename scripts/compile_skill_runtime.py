...
ROUTE_ROWS = [
    ...
    ("large", "system or cross-module change", "Route -> Requirement Analysis -> DR/Story/CodingPlan -> Coding -> Test evidence -> Review findings"),
    ("medium", "feature or existing Story", "Route -> Requirement Analysis -> Story/CodingPlan -> Coding -> Test evidence -> Review findings"),
    ("small", "bounded implementation change", "Route -> Requirement Analysis -> CodingPlan/Story -> Coding -> Test evidence -> Review findings"),
    ("micro", "BUG/config/one-file implementation change", "Route -> Requirement Analysis -> CodingPlan -> Coding -> Test evidence -> Review findings"),
