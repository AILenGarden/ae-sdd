...
>
> **真正的硬门禁**（CLI 阻断）见 `crates/ae-sdd-gates/src/registry.rs`：G-06（Task Review 通过，看 phase）/ G-08（CodingPlan 14 门禁关键词）/ G-14（CodingPlan-Story 一致性）/ **G-TASK-CTX（Task 上下文加载，v3.9.1）**。
