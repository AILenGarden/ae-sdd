...
description: |
  ...
  统一三条核心规则：① 退出条件（连续 3 轮无新增确认缺陷）② 循环上限（3 轮仍有 🔴 → 升级用户）③ Plan-first（有确认缺陷必先出 Plan）。
...
source_fallback_sha256: 5c742f712f8905ddbe22e55d213aa067e2f8fb31a9f4a324e7f78f8e05ec0376
source_original_bytes: 9255
source_original_lines: 116
source_semantic_inventory_sha256: f1401cbe517b4fc0b846e2d76631a569bcdb692166506ad4dbc1c32fce5461f3
...
- fallback_sha256: `5c742f712f8905ddbe22e55d213aa067e2f8fb31a9f4a324e7f78f8e05ec0376`
- original_lines: 116
- original_bytes: 9255
- semantic_inventory_sha256: `f1401cbe517b4fc0b846e2d76631a569bcdb692166506ad4dbc1c32fce5461f3`
...
| gate_constraint | headings: L2:21 📋 核心协议（三条，所有 review 节点必须遵守）; L2:65 🔴 禁止条款（v3.4.3 废弃）; L3:67 禁止 1：禁止"每 N 轮暂停问人"; +1 more; keyword_hits: 16 | source/docs/ae-sdd-design.md §5; tools/lib/gates.py:GATE_REGISTRY | Preserve gate identifiers in index; CLI gate output remains higher authority than prose. |
...
| design_alignment | keyword_hits: 9 | source/docs/ae-sdd-design.md; source/docs/ae-sdd-implementation-architecture.md; source/docs/skill-runtime-compiler.md | Index the alignment surface; update design docs before changing behavior. |
| fallback_only_detail | headings: L2:111 📖 实施历史; keyword_hits: 9 | source/skill-fallbacks/**; source/CHANGELOG/** | Do not summarize aggressively; keep only the location signal and rely on fallback for exact detail. |
...
| 2 | 21 | 📋 核心协议（三条，所有 review 节点必须遵守） |
| 3 | 23 | 协议 1：退出条件 |
| 3 | 36 | 协议 2：循环上限 |
| 3 | 52 | 协议 3：Plan-first（有确认缺陷必先出 Plan） |
| 2 | 65 | 🔴 禁止条款（v3.4.3 废弃） |
| 3 | 67 | 禁止 1：禁止"每 N 轮暂停问人" |
| 3 | 78 | 禁止 2：禁止无循环上限 |
| 2 | 84 | 📌 各节点专属配置（本协议只管骨架，专属配置由各 SKILL 自定义） |
| 2 | 100 | 🔗 与其他 SKILL 的关系 |
| 2 | 111 | 📖 实施历史 |
