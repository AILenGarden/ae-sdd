...
> **🆕 v3.1.3 强化：** CodingPlan 有 14 条门禁，RA 也必须有可操作的硬门禁。本节把原 8 道闸扩展为 **16 道 RA 质量闸**。所有门禁必须逐项判定，禁止"整体看起来可以"。
...
- **重跑全部门禁**：任何修补完成后必须重新跑 RA-G01~RA-G16。
- **禁止自我声明通过**：每条门禁必须写出判定依据；无依据的 ✅ 视为失败。
- **上游事实变化才重跑全流程**：只有用户补充了新目标/新角色/新业务规则等上游事实，才回到第 -1 步或第一步重新分析。
...
| 24 | 第七步 | 16 道 RA 质量闸 | RA-G01~RA-G16 全过 | §第七步 |
