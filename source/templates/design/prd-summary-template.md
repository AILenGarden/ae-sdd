...
| --- | --- | --- | --- |
| 1 | PRD 业务全貌 | 🔴 必填 | 全部 |
| 2 | 跨 Story 关键决策 | 🔴 必填 | 全部 |
| 2.1 | └ {决策标题} | 🔴 必填 | 有跨 Story 决策时 |
| 2.2 | └ {决策标题} | 🔴 必填 | 有跨 Story 决策时 |
| 3 | sizeBudget 实际 vs 估算 | 🔴 必填 | 全部 |
| 4 | 残留风险与后续行动 | 🔴 必填 | 全部 |
| 5 | 下一步建议 | 🔴 必填 | 全部 |
| 5.1 | └ 给下一个 session | 🔴 必填 | 全部 |
| 5.2 | └ 给下一个 PRD | 🔴 必填 | 全部 |
| 5.3 | └ 给 ae-sdd 母版的反馈 | 🟡 选填 | 有反馈时 |
...
### 2.1 {决策标题，如"是否在 STORY-002 中同步做 STORY-007 的接口预埋"}
