...
## §0.5 RequirementAnalysisModel 决策记录（🔴 必填）
...
| RA-G14 | 缺口管理闭环 | ☐ | {证据} |
| RA-G15 | 规模与路由有依据 | ☐ | {证据} |
| RA-G16 | 实现视角与落盘审核完成 | ☐ | §9-quater + G-RA-6 扫描结果 + {落盘/审核证据} |

---

## §14 🆕 RA ↔ DR/Story/Task 关联矩阵（v3.2 新增 — 双向追溯核心）
