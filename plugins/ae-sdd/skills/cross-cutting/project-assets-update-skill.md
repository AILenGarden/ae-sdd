...
### 3.2 10 步 SOP（详见 `project-assets-schema.md §9`）
...
| 10 | 审计 + 写 §1 lastAuditedAt + 写更新日志 | §1 + log |

### 3.3 输出物

- `skills/ae-sdd/project-assets/{project-key}/{project-key}.assets.md`（按 schema 12 节填写，含 §10 经验文档）
