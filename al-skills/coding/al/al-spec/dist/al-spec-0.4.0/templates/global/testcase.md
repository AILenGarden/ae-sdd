...
> This template is required context for the `testcase` SKILL. Load the invoking
> SKILL first; its body is the authoritative TestCase writing specification.
> Load the matching project SKILL when the project is known. Related context is
> optional.
