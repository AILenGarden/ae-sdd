...
- 文档类型：DR 技术方案
- DR ID：DR-{number}
- 项目前缀：<project-prefix>（用于生成 Story 文件名，如：`2c-im`）
- 可选来源规格：
- 作者：
- 创建日期：
- 最后更新：
...
> 示例：DR ID: DR-001，项目前缀: {project-prefix}，可选来源规格：，创建日期: 2026-05-14，状态: Draft
...
- **粒度参考**：单个 Story 预计开发时间 **≤4 天**（硬性上限，超过必须拆分）
