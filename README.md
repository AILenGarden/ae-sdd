...
>
> **版本：** 2026-06-10（最新变更：ae-sdd 改名 + 母版目录重组 + 4 类需求智能路由 + Story Review 7 件套 + 5 审核节点 + `.ae-task`/`.ae-plan` 隐藏目录 + 同工作流文档收束原则 + 跨 AI 工具适配抽象层 + 协同插件`plugins/ae-sdd/`同步）
>
