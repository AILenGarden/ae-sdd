...
>
> **版本：** v3.7.3（🆕 2026-07-01：CodingProcess 5 上下文改为项目约束/技术约束/Story/Task/TestCase（原第⑤项目资产并入 CodeAnalysis 内部步骤），读取统一走 document-storage-skill。历史变更见 `source/CHANGELOG/`。）
>
